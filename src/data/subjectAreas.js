...
for(const year of years){
    ...
    for(const entry of entries){
        ...
        for(const subjectArea of subjectAreas){
            ...
            if(subjectGroups[subjectGroupName] == null) subjectGroups[subjectGroupName] = {groupName:subjectGroupName, subjectAreas:{}, frequency: 0, overlapFrequency: 0};
            ...
            if(subjectGroup.subjectAreas[subjectCode] == null) subjectGroup.subjectAreas[subjectCode] = {
                name:subjectName,
...
fs.writeFileSync(path.join(resourcePath, "processed", "subject_areas.json"), JSON.stringify(subjectGroups))